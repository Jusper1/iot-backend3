...
func NewSPJHandler(s *services.SPJService) *SPJHandler {
	return &SPJHandler{
		Service: s,
	}
}
...
func (h *SPJHandler) FindByID(c *gin.Context) {
	...
	if err != nil {
		...
		if errors.Is(err, services.ErrSPJNotFound) {
...
func (h *SPJHandler) FindByOrderID(c *gin.Context) {
