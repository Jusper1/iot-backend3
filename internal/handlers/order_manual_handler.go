...
type OrderManualHandler struct {
	Service *services.OrderManualService
}

func NewOrderManualHandler(s *services.OrderManualService) *OrderManualHandler {
	return &OrderManualHandler{Service: s}
}

func (h *OrderManualHandler) Create(c *gin.Context) {
	...
	c.JSON(http.StatusCreated, gin.H{
		"success": true,
		"message": "data manual berhasil dibuat",
		"data":    data,
	})
}
...
func (h *OrderManualHandler) FindByOrderID(c *gin.Context) {
...
func (h *OrderManualHandler) Update(c *gin.Context) {
	id, err := strconv.ParseUint(c.Param("id"), 10, 64)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{
			"success": false,
...
func (h *OrderManualHandler) DeleteByOrderID(c *gin.Context) {
	orderID, err := strconv.ParseUint(c.Param("order_id"), 10, 64)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{
			"success": false,
